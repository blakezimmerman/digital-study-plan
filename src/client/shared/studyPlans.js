...
export const majors = [
  {
    ...
    semesters: [
      ...
      [
        ...
        { code: 'E-102', name: 'Engineering Experience II', credits: 1.0, term: 2, id: 'sw-r-13' },
      ...
      [
        ...
        { code: 'SSW-315', name: 'Object Oriented Software Development', credits: 3.0, term: 5, id: 'sw-r-36' },
      ...
      [
        ...
        { code: '', name: 'Technogenesis Core', credits: 3.0, term: 7, id: 'sw-t-48' },
      ...
      [
        ...
        { code: '', name: 'General Elective', credits: 3.0, term: 8, id: 'sw-e-54' },
        { code: '', name: 'Humanities', credits: 3.0, term: 5, id: 'sw-h-55' },
      ]
    ]
  },
  {
